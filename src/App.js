...
function App() {
  return (
    <div
      className="bg-gradient-to-b from-purple-900 via-indigo-900 to-black min-h-screen font-sans"
      style={{
        backgroundImage: `url(${require("./assets/neon-city.webp")})`,
    ...
    >
      <header className="flex flex-col items-center justify-center text-center p-10">
        ...
        />
        <h1 className="text-white drop-shadow-lg text-4xl md:text-6xl font-bold tracking-wide">
          Trump6 Coin
        </h1>
        <p className="text-white drop-shadow-md text-lg md:text-2xl mt-4 text-pink-400">
      ...
      <section className="px-6 md:px-20 py-10">
        <h2 className="text-white drop-shadow-lg text-3xl md:text-4xl font-semibold mb-6">
          About Trump6
        </h2>
        <h3 className="text-pink-400 drop-shadow-md text-xl md:text-2xl font-bold mb-4">
          Trump6 – Own the Streets, Own the Future
        </h3>
        <p className="text-white drop-shadow-md text-lg mb-4">
      ...
      <section className="bg-black/30 px-6 md:px-20 py-10 rounded-xl">
        <h2 className="text-white drop-shadow-lg text-3xl md:text-4xl font-semibold mb-6">
          Tokenomics
        </h2>
        <ul className="text-white drop-shadow-md text-lg space-y-2 list-disc list-inside">
      ...
      <section className="px-6 md:px-20 py-10">
        ...
        <div className="grid md:grid-cols-3 gap-6 text-center">
          <div className="bg-white/10 p-6 rounded-xl shadow-lg">
            <h3 className="text-white drop-shadow-md text-xl font-bold">Kevin R.</h3>
            <p className="text-white drop-shadow-sm">Founder & Visionary</p>
          </div>
          <div className="bg-white/10 p-6 rounded-xl shadow-lg">
            <h3 className="text-white drop-shadow-md text-xl font-bold">Jessica L.</h3>
            <p className="text-white drop-shadow-sm">Marketing & Community</p>
          </div>
          <div className="bg-white/10 p-6 rounded-xl shadow-lg">
            <h3 className="text-white drop-shadow-md text-xl font-bold">Daniel M.</h3>
            <p className="text-white drop-shadow-sm">Smart Contract Dev</p>
          </div>
        </div>
      </section>

      {/* Roadmap Section */}
      <section className="bg-black/40 px-6 md:px-20 py-10 rounded-xl my-10">
        <h2 className="text-white drop-shadow-lg text-4xl font-bold mb-8 text-center">
          🎮 TRUMP6 Roadmap 🚀
        </h2>

        <p className="text-white drop-shadow-md text-lg mb-6 max-w-4xl mx-auto text-center">
          TRUMP6 isn’t just another meme coin. It’s a wild ride through meme culture, pop narrative, and crypto chaos—straight outta Vice City! Inspired by the energy of GTA6, TRUMP6 blends hype, humor, and utility to take over the blockchain streets. 🏎️💥
        </p>

        <div className="space-y-10 max-w-4xl mx-auto text-white drop-shadow-md">

          <div>
            <h3 className="text-pink-400 text-2xl font-semibold mb-3">Phase 1: Loading the Game 💾🔥</h3>
          ...
          <div>
            <h3 className="text-pink-400 text-2xl font-semibold mb-3">Phase 2: Entering Vice Mode 🌴🚗</h3>
            <ul className="list-disc list-inside space-y-1">
          ...
          <div>
            <h3 className="text-pink-400 text-2xl font-semibold mb-3">Phase 3: Unlocking Real Utility 🔓💰</h3>
            <ul className="list-disc list-inside space-y-1">
          ...
          <div>
            <h3 className="text-pink-400 text-2xl font-semibold mb-3">Phase 4: The Final Heist – Global Takeover 🌍🕶️</h3>
            <ul className="list-disc list-inside space-y-1">
          ...
          <p className="text-white drop-shadow-md text-center mt-8 font-semibold text-xl">
            🚀 The Revolution Has Just Started<br/>
            TRUMP6 is not just a coin—it’s a narrative-powered movement.<br/>
            It’s time to meme like a maniac, build like a boss, and ride through Web3 with full throttle. 🏁
          </p>
        </div>
      </section>

      <footer className="text-center text-sm text-gray-300 mt-10 py-6 border-t border-gray-700 drop-shadow-sm">
